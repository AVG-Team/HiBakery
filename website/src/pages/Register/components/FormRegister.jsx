...
export const SignUp = () => {
    ...
    return (
        <div className="container flex items-center justify-center w-full min-h-screen p-4">
            <div className="w-full max-w-4xl overflow-hidden bg-white rounded-lg shadow-lg">
                <div className="flex flex-col w-full md:flex-row">
                    <div className="w-full p-8 md:w-1/2">
                        ...
                        <button
                            className="group relative min-h-[40px] rounded-xl w-full overflow-hidden border border-Coral-Pink-500 bg-white text-Coral-Pink-500 shadow transition-all before:absolute 
                        ...
                        >
                            <span className="top-0 flex items-center justify-center w-full h-full before:absolute before:bottom-0 before:left-1/4 before:z-0 before:h-0 before:w-1/4 before:bg-Coral-Pink-500 before:duration-500 after:absolute after:right-1/4 after:top-0 after:z-0 after:h-0 after:w-1/4 after:bg-Coral-Pink-500 after:duration-500 hover:text-white group-hover:before:h-full group-hover:after:h-full"></span>
                            <span className="absolute top-0 bottom-0 left-0 right-0 z-10 flex items-center justify-center w-full h-full group-hover:text-white">
                                Login
                            </span>
                        </button>
                        <button className="flex items-center justify-center w-full px-4 py-2 mt-4 text-gray-700 transition duration-300 bg-white border border-gray-300 rounded-lg hover:scale-110 hover:border-Coral-Pink-500">
