...
import avg.web.backend.dto.UserDTO;
import avg.web.backend.entities.Authority;
import avg.web.backend.entities.User;
import avg.web.backend.exception.EmailAlreadyUsedException;
import avg.web.backend.exception.InvalidPasswordException;
import avg.web.backend.exception.UsernameAlreadyUsedException;
