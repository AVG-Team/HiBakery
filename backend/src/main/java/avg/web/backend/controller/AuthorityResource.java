...
import avg.web.backend.repository.AuthorityRepository;
...
/**
 * REST controller for managing {@link avg.web.backend.entities.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    public ResponseEntity<Authority> createAuthority(@Valid @RequestBody Authority authority) throws AppException, URISyntaxException {
        LOG.debug("REST request to save Authority : {}", authority);
        if (authorityRepository.existsById(authority.getName())) {
            throw new AppException(ErrorCode.AUTHORITY_EXISTS);
        }
