            ...
            <tbody>
              {orderDetailList.map((orderDetail, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {orderDetail.createdAt ? <TextFormat type="date" value={orderDetail.createdAt} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {orderDetail.updatedAt ? <TextFormat type="date" value={orderDetail.updatedAt} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {orderDetail.deletedAt ? <TextFormat type="date" value={orderDetail.deletedAt} format={APP_DATE_FORMAT} /> : null}
                  </td>
