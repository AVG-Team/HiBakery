...
import { deleteEntity, getEntity } from './images.reducer';
...
export const ImagesDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.images.delete.question">Are you sure you want to delete Images {imagesEntity.id}?</ModalBody>
      <ModalFooter>
