...
import reducer, {
  ...
  reset,
  updateEntity,
} from './password-reset-tokens.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASSWORDRESETTOKENS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PASSWORDRESETTOKENS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PASSWORDRESETTOKENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PASSWORDRESETTOKENS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PASSWORDRESETTOKENS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PASSWORDRESETTOKENS actions', async () => {
      const arg = 42666;
