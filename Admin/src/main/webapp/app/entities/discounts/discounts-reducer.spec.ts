...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './discounts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISCOUNTS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISCOUNTS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISCOUNTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DISCOUNTS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DISCOUNTS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISCOUNTS actions', async () => {
      const arg = 42666;
