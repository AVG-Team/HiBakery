...
import { deleteEntity, getEntity } from './bills.reducer';

export const BillsDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(billsEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adminApp.bills.delete.question">Are you sure you want to delete Bills {billsEntity.id}?</ModalBody>
      <ModalFooter>
...
export default BillsDeleteDialog;
