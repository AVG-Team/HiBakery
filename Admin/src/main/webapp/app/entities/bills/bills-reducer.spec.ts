...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './bills.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BILLS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLS actions', async () => {
      const arg = 42666;
