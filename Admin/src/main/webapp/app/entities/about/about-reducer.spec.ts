...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './about.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABOUT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ABOUT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ABOUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ABOUT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ABOUT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ABOUT actions', async () => {
      const arg = 42666;
