...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTDETAIL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTDETAIL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PRODUCTDETAIL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTDETAIL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTDETAIL actions', async () => {
      const arg = 42666;
