...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SETTINGSYSTEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SETTINGSYSTEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SETTINGSYSTEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SETTINGSYSTEM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SETTINGSYSTEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SETTINGSYSTEM actions', async () => {
      const arg = 42666;
